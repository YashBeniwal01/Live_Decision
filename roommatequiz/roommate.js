...
function showResults() {
    ...
    let decision;
    if (userScore >= 30) {
        decision = "You and your roommate have a fantastic relationship! Keep up the good work.";
    } else if (userScore >= 10) {
        decision = "Your relationship with your roommate is generally positive, with some room for improvement.";
    } else if (userScore >= -10) {
        decision = "There are some challenges in your relationship with your roommate. Consider open communication to address concerns.";
    } else if (userScore >= -20) {
        decision = "Your relationship with your roommate may need attention. It's essential to address conflicts and work towards understanding.";
    } else {
        decision = "It seems there are significant challenges in your relationship with your roommate. Open communication and understanding are crucial.";
    }
    ...
    }, 5000); // Show the pop-up after 20 seconds   
...
function like() {
        let likeCount = parseInt(localStorage.getItem("roommateLikeCount")) || 0;

        // Increment the like count by 1
        likeCount++;

        // Update the like count in Local Storage
        localStorage.setItem("roommateLikeCount", likeCount);
...
function updateCureContainer(userScore) {
    ...
    const cureContent = {
        Excellent: [
            "Continue nurturing your positive relationship with your roommate through open communication and shared activities. Keep up the fantastic connection!"
        ],
        Good: [
            "Build on the positive aspects of your relationship with your roommate. Identify areas for improvement and work together to strengthen your bond."
        ],
        Average: [
            "Enhance your roommate relationship by focusing on effective communication and finding common ground. Explore shared interests to deepen your connection."
        ],
        Challenging: [
            "Address the challenges in your relationship by fostering open communication. Seek understanding and compromise to overcome obstacles and create a more harmonious living arrangement."
        ],
        Critical: [
          
            "Acknowledge and address the significant challenges in your roommate relationship. Consider seeking mediation or professional advice to navigate through the issues and work towards a healthier living dynamic."
        ]
    };
